...
package com.alphagamingarcade.sync.worker
...
//                     }
    ...
    /**
     * Creates dummy sync flow that simulates progress.
     * REMOVE THIS when real repository is implemented.
     */
    private fun createDummySyncFlow() = flow {
        val total = 100
