 ...
 * @property email The name of the user. Defaults to "No Name" if not provided.
 * @property isEmailVerified The URI string for the user's profile picture, if available. Defaults to `null` if not provided.
